package com.saiabreu.aptmaintenance.domain.maintenceRequest.controllers;


import com.saiabreu.aptmaintenance.domain.maintenceRequest.models.MaintenceRequest;
import com.saiabreu.aptmaintenance.domain.maintenceRequest.services.MaintenceRequestService;
...
@RestController
@CrossOrigin
@RequestMapping("/api/v1/MaintenanceRequests")
public class MaintenceRequestController {
        ...
        public ResponseEntity<MaintenceRequest> getByEmail(@RequestParam String email){
            MaintenceRequest employee = maintenceRequestService.getByEmail(email);
